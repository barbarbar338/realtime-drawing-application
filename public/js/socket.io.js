...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \************************/
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					function lookup(uri, opts) {
						...
						var sameNamespace =
							cache[id] && path in cache[id]["nsps"];
						var newConnection =
							opts.forceNew ||
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					var Manager = /*#__PURE__*/ (function (
						...
						function Manager(uri, opts) {
							...
							_this.timeout(
								null == opts.timeout ? 20000 : opts.timeout,
							);
						...
						_createClass(Socket, [
							...
							},
							{
								...
								value: function emit(ev) {
									...
									packet.options.compress =
										this.flags.compress !== false; // event ack callback
							...
							},
							{
								...
								value: function onpacket(packet) {
									...
									switch (packet.type) {
										case socket_io_parser_1.PacketType
											.CONNECT:
											if (
												packet.data &&
												packet.data.sid
  ...
  \*******************************/
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					var StrictEventEmitter = /*#__PURE__*/ (function (
						_Emitter,
					) {
						...
						_createClass(StrictEventEmitter, [
							{
								...
								value: function on(ev, listener) {
									_get(
										_getPrototypeOf(
											StrictEventEmitter.prototype,
										),
										"on",
										this,
									).call(this, ev, listener);
  ...
  \**********************/
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					function url(uri) {
						...
						obj.id =
							obj.protocol + "://" + host + ":" + obj.port + path; // define href

						obj.href =
							obj.protocol +
							"://" +
							host +
							(loc && loc.port === obj.port
								? ""
								: ":" + obj.port);
						return obj;
					}
					...
					var Socket = /*#__PURE__*/ (function (_Emitter) {
						...
						function Socket(uri) {
							...
							if (typeof _this.opts.query === "string") {
								_this.opts.query = parseqs.decode(
									_this.opts.query,
								);
							} // set on handshake
  ...
  \***************************************************************/
				...
				/***/ function (module, exports, __webpack_require__) {
					var XMLHttpRequest = __webpack_require__(
						/*! ../../contrib/xmlhttprequest-ssl/XMLHttpRequest */ "./node_modules/engine.io-client/lib/xmlhttprequest.js",
					);
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					var Request = /*#__PURE__*/ (function (_Emitter) {
						...
						function Request(uri, opts) {
							...
							_this2.data =
								undefined !== opts.data ? opts.data : null;
  ...
  \*******************************************************************/
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					var withNativeArrayBuffer =
						typeof ArrayBuffer === "function";
					var base64decoder;

					if (withNativeArrayBuffer) {
						base64decoder = __webpack_require__(
							/*! base64-arraybuffer */ "./node_modules/engine.io-parser/node_modules/base64-arraybuffer/lib/base64-arraybuffer.js",
						);
					}
  ...
  \*******************************************************************/
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					var withNativeArrayBuffer =
						typeof ArrayBuffer === "function"; // ArrayBuffer.isView method is not defined in IE10
  ...
  \****************************************************/
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					var encodePayload = function encodePayload(
						packets,
						callback,
					) {
					...
					var decodePayload = function decodePayload(
						...
						for (var i = 0; i < encodedPackets.length; i++) {
							var decodedPacket = decodePacket(
								encodedPackets[i],
								binaryType,
							);
						...
						if (is_binary_1.isBinary(data)) {
							...
							for (var key in data) {
								if (data.hasOwnProperty(key)) {
									_newData[key] = _deconstructPacket(
										data[key],
										buffers,
									);
								}
  ...
  \*****************************************************/
				...
				/***/ function (module, exports, __webpack_require__) {
					...
					(function (PacketType) {
						...
						PacketType[(PacketType["DISCONNECT"] = 1)] =
							"DISCONNECT";
						PacketType[(PacketType["EVENT"] = 2)] = "EVENT";
						PacketType[(PacketType["ACK"] = 3)] = "ACK";
						PacketType[(PacketType["CONNECT_ERROR"] = 4)] =
							"CONNECT_ERROR";
						PacketType[(PacketType["BINARY_EVENT"] = 5)] =
							"BINARY_EVENT";
						PacketType[(PacketType["BINARY_ACK"] = 6)] =
							"BINARY_ACK";
					})(
						(PacketType =
