var rough = (function () {
	...
	function s(e, s) {
		...
		const h = (function (t, e) {
			...
			for (; o.length || a.length; ) {
				if (a.length) {
					let t = -1;
					for (let e = 0; e < a.length && !(a[e].ymin > h); e++)
						t = e;
	...
	function m(t, e, s) {
		...
		if (n > 2) {
			...
			return (
				e &&
					a.push(...I(t[n - 1][0], t[n - 1][1], t[0][0], t[0][1], s)),
				{ type: "path", ops: a }
			);
		}
		return 2 === n
	...
	function P(t, e, s) {
		const n = Math.sqrt(
			...
			a = Math.ceil(
				Math.max(
					s.curveStepCount,
					(s.curveStepCount / Math.sqrt(200)) * n,
				),
			),
			o = (2 * Math.PI) / a;
		let h = Math.abs(t / 2),
	...
	function T(t) {
		return (
			t.randomizer || (t.randomizer = new l(t.seed || 0)),
			t.randomizer.next()
		);
	}
	...
	function W(t, e, s) {
		...
		if (n > 3) {
			...
			3 === n
				...
				: 2 === n &&
				  a.push(...I(t[0][0], t[0][1], t[1][0], t[1][1], s));
		return a;
	}
	...
	function E(t, e, s, n, a, o, h, r, i) {
		...
		for (let o = c; o <= h; o += t)
			l.push([
				A(r, i) + e + n * Math.cos(o),
				A(r, i) + s + a * Math.sin(o),
			]);
		return (
	...
	function q(t, e, s) {
		...
		if (0 === n) return R(t, e);
		let a =
			((t[0] - e[0]) * (s[0] - e[0]) + (t[1] - e[1]) * (s[1] - e[1])) / n;
	...
	function F(t, e, s, n) {
		...
		if (
			...
			const s = t[e + 0];
			if (a.length) {
				((o = a[a.length - 1]), (h = s), Math.sqrt(R(o, h))) > 1 &&
					a.push(s);
			} else a.push(s);
			a.push(t[e + 3]);
		} else {
			...
			for (const o of e)
				switch (o.type) {
					case "path":
						n.save(),
							(n.strokeStyle =
								"none" === s.stroke ? "transparent" : s.stroke),
		...
		fillSketch(t, e, s) {
			...
			n < 0 && (n = s.strokeWidth / 2),
				...
				s.fillLineDashOffset &&
					(t.lineDashOffset = s.fillLineDashOffset),
	...
	class K {
		...
		fillSketch(t, e, s) {
			...
			return (
				a.setAttribute(
					"d",
					this.opsToPath(e, s.fixedDecimalPlaceDigits),
				),
